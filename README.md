...
Extensive feature set generation is done by combining correlated assets, ARIMA, technical analysis, and windowed rough path signatures. Only the open price and lagged close price are used in the calculation of technical indicators as knowledge of the close price is not known in real time.
